            ...
            <div className={modalStyleVF.frase}>
                <form onSubmit={submit}>
                    ...
                    <div className={modalStyleVF.contenido}>
                        ...
                        <button type="submit" className={modalStyleVF.btn}><IoAddCircle className={modalStyleVF.add} size={35} /></button>
                    </div>
                </form>
                ...
                <ul className={modalStyleVF.lisF}>
                    {lista.map((elem, i) => {
                        return (
                            <li key={`concepto-${i}`} className={modalStyleVF.liF}>
                        ...
                        <ul className={modalStyleVF.uldina}>
                            {ListaVistaP.map((elem, i) => {
                                return (
                                    ...
                                    <li key={`concepto-${i}`} className={modalStyleVF.liD}>
