...
export default function DefinitionModal({ editor, isOpen, onClose }) {
    ...
    return (
        <Modal title="Ejercicio de definiciones" isOpen={isOpen} onClose={onClose}>
                    ...
                    <form onSubmit={(e) => {
                        ...
                        <div className={style.form}>
                            ...
                            <div className={style.align}>
                                ...
                                <button type="submit" className={style.plusButton} onClick={() => { setModify([...isModify, false]) }}><IoAddCircle size={35} /></button>
                            </div>
                        </div>
                    </form>
