...
export default function ToolbarBlockButton({
	...
	return (
		<button
			...
			} flex items-center gap-1 rounded-sm bg-grey-dark p-1.5 hover:bg-opacity-40 focus-visible:ring-2 focus-visible:ring-focus focus-visible:ring-opacity-30 shrink-0`}
			onClick={() => {
