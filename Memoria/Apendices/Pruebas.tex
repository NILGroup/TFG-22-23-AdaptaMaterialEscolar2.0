...
A continuación se expone la tabla (Tabla \ref{tab:v/f}) con los casos de prueba de la funcionalidad de verdadero/falso y el procedimiento para hacer dichos casos.
...
A continuación se expone la tabla (Tabla \ref{tab:definiciones}) con los casos de prueba de la funcionalidad de definiciones y el procedimiento para hacer dichos casos.
...
A continuación se expone la tabla (Tabla \ref{tab:resumen}) con los casos de prueba de la funcionalidad de generar resumen y el procedimiento para hacer dichos casos.
...
A continuación se expone la tabla (Tabla \ref{tab:leyenda}) con los casos de prueba de la funcionalidad de leyenda de colores y el procedimiento para hacer dichos casos.
...
A continuación se expone la tabla (Tabla \ref{tab:dibujar}) con los casos de prueba de la funcionalidad de espacios para dibujar y el procedimiento para hacer dichos casos.
...
A continuación se expone la tabla (Tabla \ref{tab:pictotraductor}) con los casos de prueba de la funcionalidad de pictotraductor y el procedimiento para hacer dichos casos.
...
\begin{table}[H]
    ...
    \begin{tabular}[c]{@{}l@{}}TextoOriginal=\\ “La libélula tiene cuatro alas”\end{tabular} & vista picto & Longitud de texto\textgreater 0 & visualización de todos los  picto oculta & botón Ok deshabilitado \\ \hline
    \end{tabular}
    }
...
A continuación se expone la tabla (Tabla \ref{tab:mate}) con los casos de prueba de la funcionalidad de ejercicios de matemáticas y el procedimiento para hacer dichos casos.
