...
% En la sección \ref{sec:arasaac} se explica la API de ARASAAC que usamos para obtener los pictogramas.
...
% \section{API de ARASAAC}\label{sec:arasaac}
% Para obtener los pictogramas continuaremos utilizando la API pública que proporciona el Centro Aragonés para la Comunicación Aumentativa y Alternativa (ARASAAC)\footnote{\url{https://arasaac.org/}}, que ya se utilizó en el desarrollo de AdaptaMaterialEscolar 1.0.