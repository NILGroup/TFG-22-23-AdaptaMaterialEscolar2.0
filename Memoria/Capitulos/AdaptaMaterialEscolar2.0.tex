...
Una vez que cada integrante ha explicado su diseño, hemos cogido lo mejor de cada uno quedando la aplicación de la siguiente manera.
...
\begin{figure}[ht!]
    \centering
    \includegraphics[scale=0.3]{IteracionCompetitiva2}
    \caption{}
    \label{IteracionCompetitiva2}
\end{figure}
\begin{figure}[ht!]
    \centering
    \includegraphics[scale=0.3]{IteracionCompetitiva3}
    \caption{}
    \label{IteracionCompetitiva3}
\end{figure}
\begin{figure}[ht!]
    \centering
    \includegraphics[scale=0.3]{IteracionCompetitiva4}
    \caption{}
