...
En este capítulo se explicará la metodología de desarrollo utilizada en la Sección \ref{cap:Kanban} y se describirán las medidas tomadas para asegurar la calidad del software en la Sección \ref{sec:qa}.
