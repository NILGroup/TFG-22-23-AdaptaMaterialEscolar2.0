...
\begin{itemize}
    ...
    \item Intangible: Tareas que son nuevas, se desconoce el tiempo que se le va a dedicar y el riesgo que suponen. Por ejemplo, una refactorización del código.
\end{itemize}
