...
\begin{itemize}
    ...
    \item Ejercicios de verdadero o falso: Genera una lista ordenada o no ordenada con las frases introducidas permitiendo definir cuales son verdaderas o falsas.
\end{itemize}
