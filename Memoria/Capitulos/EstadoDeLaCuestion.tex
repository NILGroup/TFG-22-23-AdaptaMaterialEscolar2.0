...
En cuanto al editor de texto utilizado en la aplicación, se optó por CKEditor\footnote{\url{https://ckeditor.com/}}, una solución \textit{open source} que proporciona una amplia gama de funciones de edición y formateo de texto todo ello para incluir los ejercicios realizados por el profesor.
