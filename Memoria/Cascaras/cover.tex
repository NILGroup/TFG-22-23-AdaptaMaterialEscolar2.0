...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\tituloPortada{%
AdaptaMaterialEscolar 2.0: Mejorando una herramienta para la adaptación de asignaturas a necesidades educativas especiales
}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\tituloPortadaEng{%
AdaptaMaterialEscolar 2.0: Improving a tool for adapting subjects to special educational needs
}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\autorPortada{{Álvaro Gómez Sittima\\ Dunia Namour Doughani\\ Alberto Alejandro Rivas Fernández\\ Johan Sebastian Salvatierra Gutierrez}}
...
\textbf{Convocatoria: }\textit{{Mayo/Junio} \the\year}%\\[0.2em]
